...
### Project author
Moges Tesfaye and Sadiq mukhtar usman Mukhtar
...
### Note
This project was created in a repository separate from (https://github.com/mostf27/sorting_algorithms), where the other projects from this section are located.
